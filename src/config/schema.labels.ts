...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.web.search.exa.baseUrl": "Exa MCP Base URL",
  "tools.web.search.exa.numResults": "Exa Search Results Count",
  "tools.web.search.exa.livecrawl": "Exa Live Crawl Mode",
  "tools.web.search.exa.type": "Exa Search Type",
  "tools.web.search.exa.contextMaxCharacters": "Exa Context Max Characters",
